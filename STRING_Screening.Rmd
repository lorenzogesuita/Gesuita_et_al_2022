...
# 1. choose a folder and set it as your working directory (wd) indicating its path below; be sure to have a "/" at the end of the string.
# 2. put the "datasets" folder in your working directory folder.
# 3. run the code: the output will be three .csv files reporting all interacting proteins between microglia and SST+ interneurons, PV+ interneurons or pyramidal cells.

wd <- "~/Documents/University_of_Zurich_PhD/Lab/ProjectB_Microglia/STRING_Screening/"
setwd(wd)
